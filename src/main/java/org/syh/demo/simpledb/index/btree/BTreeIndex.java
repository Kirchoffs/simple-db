...
public class BTreeIndex implements Index {
    ...
    public BTreeIndex(Transaction tx, String indexName, Layout leafLayout) {
        ...
        // Difference between leaf layout and directory layout
        // leafTable: blockNum, slot, dataVal
        // directoryTable: blockNum, dataVal
    ...
    public void beforeFirst(Constant searchKey) {
        ...
        // Find the block whose min dataVal is smaller than or equal to the searchKey
