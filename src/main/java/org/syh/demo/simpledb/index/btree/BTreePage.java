...
public class BTreePage {
    ...
    // A directory page uses flag to hold its level (lowest level directory page has flag as 0)
    ...
    // The original data is transferred to the new block
    ...
    public void insertLeafData(int slot, Constant val, Rid dataRid) {
        insert(slot);
        setVal(slot, "dataVal", val);
    ...
    public void format(int flag) {
        format(currentBlockId, flag);
    }
